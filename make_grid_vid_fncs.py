...
def get_grid_vids(save_dir_name, state_to_track_start_end_is, exp_date_to_jpeg_dir,track_to_date, state_to_title_label, max_clip_len,  vid_fps, n_post_frames, n_pre_frames, vid_name_supp =""):
